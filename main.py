...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_name", default="mvtec-ad-ad", choices=['mvtec-ad-loco-ad', 'mvtec-ad-ad', 'fgvc-aircraft', 'mpdd', 'aptos'], help="Name of the dataset")
    ...
    parser.add_argument("--run_type", default="cdad", help="The files that have to be run.")
    parser.add_argument("--model_type", default="ViT", choices=['ViT', 'MLP'], help="The type of model to be trained for CDAD.")
    ...
    parser.add_argument("--fake_feature_type", type=str, default="noise_all", help="The type of fake featuers to create for CDAD.")
